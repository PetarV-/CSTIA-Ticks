...
// Modified by Petar Velickovic to support URL File Streams.
...
public class WavFile
{
  private enum IOState {READING, WRITING, CLOSED};
	...
	public static WavFile openWavFile(URLConnection conn) throws IOException, WavFileException
	{
		...
		wavFile.iStream = conn.getInputStream();
